...
var speed : float = 1.5;
private var mageController : CharacterController;
...
//	statusGUI.text = actions[indexAction];
	mageController = GetComponent(CharacterController);
...
//	}
	...
	if(mageController.isGrounded == true) {
...
//	mageController.transform.Rotate(0, rotateY, 0);
	moveDirection.y -= gravity * Time.deltaTime;
	mageController.Move(moveDirection * Time.deltaTime);
}
